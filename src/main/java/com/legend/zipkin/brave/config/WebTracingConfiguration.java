package com.legend.zipkin.brave.config;
...
public class WebTracingConfiguration extends WebMvcConfigurerAdapter {
    ...
    Reporter<Span> reporter() {
        // return new LoggingReporter(); // Just log json info!!!
    ...
    @Bean
    Brave brave() {
        return new Brave.Builder("brave-springmvc-quickstart").reporter(reporter()).build();
    }
